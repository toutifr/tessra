...
const sections: Section[] = [
  ...
  },
  {
    ...
    body:
      "Tiles have freshness: 🔥 Alive → 🕯 Fading → ❄️ Cold. Return physically and revive (1×/20h, +5 ⬡) to stop decay. 3+ connected tiles = a territory: it glows gold and earns +10 ⬡/tile daily while fresh.",
  },
  {
    icon: "🎯",
    title: "Daily targets",
    body:
      "Every day, 3 missions near you on the map: 📸 Scout a virgin tile (+50 ⬡), 🔥 Revive your coldest tile (+30 ⬡), ⚔️ Raid the nearest rival tile (−30% on site).",
  },
  {
    icon: "⚡",
    title: "Events",
